    ...
    <Dialog.Root open={open} onOpenChange={setOpen}>
      <Dialog.Trigger asChild>
        <button
          ...
          className="flex h-9 w-9 items-center justify-center rounded-xl border border-white/[0.07] bg-white/[0.035] text-ash transition-all hover:border-violet/30 hover:bg-violet/10 hover:text-fog lg:hidden"
        >
          ...
          <Dialog.Portal forceMount>
            <Dialog.Overlay asChild forceMount>
              <motion.div
                ...
                animate={{ opacity: 1 }}
                exit={{ opacity: 0 }}
                className="fixed inset-0 z-40 bg-black/72 backdrop-blur-md lg:hidden"
              />
            </Dialog.Overlay>
              ...
              >
                ...
                <div className="relative flex h-20 items-center justify-between border-b border-white/[0.07] px-5">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="flex items-center gap-2">
                        <span className="font-display font-semibold tracking-[0.16em] text-fog">CURSED</span>
                  ...
                  <Dialog.Close asChild>
                    <button type="button" aria-label="Close navigation" className="flex h-9 w-9 items-center justify-center rounded-xl border border-white/[0.07] bg-white/[0.035] text-ash hover:border-crimson/25 hover:bg-crimson/10 hover:text-fog">
                      <X className="h-4 w-4" />
                    </button>
                  </Dialog.Close>
                </div>
                    ...
                    return (
                      <Link
                        ...
                        className={cn(
                          ...
                          isActive
                            ? "border-violet/30 bg-gradient-to-r from-violet/20 to-crimson/[0.08] text-fog"
                            : "border-transparent text-ash hover:border-white/[0.06] hover:bg-white/[0.035] hover:text-fog"
                        )}
                      >
                        <span className={cn("flex h-8 w-8 items-center justify-center rounded-lg", isActive ? "bg-violet/15 text-violet-bright" : "bg-white/[0.025]")}>
